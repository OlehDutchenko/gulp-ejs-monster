...
История рендера текущей страницы, при помоще которой вы сможете отследить последовательность действий плагина
...
`locals` - это единный глобальный объект хранищие в себе локальные значения, который будет доступен для работы шаблонизатора.
...
- _описание_:	Объект имеет набор свойств
	...
	- `mtime` - Дата последней модификации файла, если кэширование выключенно - всегда равен `1`
