...
> If this approach to working with template templates `ejs` does not suit you, you can not read further and do not create queries, since we do not intend to change it)))
